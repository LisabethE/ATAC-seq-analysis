Bulk ATAC-seq analysis of human naive and activated CD4+ T cells
...
#QC: Fragment insert size distribution
conda deactivate
...
#pileup for visualisation in the UCSC genome browser
